...
if(isset($_POST['register']))
{
    ...
    $date=$_POST['date'];
    $query="INSERT INTO user_registration_form (admin_name,admin_email,date,admin_gender,admin_location,password)VALUES('$name','$email','$date','$gender','$district','$password')";
 ...
 if(isset($_POST['login']))
{
   ...
   $query="SELECT * from user_registration_form WHERE admin_email='$email'";
   $save=mysqli_query($conn,$query);
   if(mysqli_num_rows($save) > 0){
          ...
          if(password_verify($password,$row['password'])){
            echo "sucessfully1";
             ...
             header("Location: http://localhost/bertheproject/home.php");
